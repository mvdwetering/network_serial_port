...
class NetworkSerialPortBinarySensor(
    CoordinatorEntity[NetworkSerialPortCoordinator], BinarySensorEntity
):
    ...
    def __init__(
        ...
        self.entity_description: NetworkSerialPortEntityBinarySensorDescription = (
            entity_description
        )
